...
def main():
    env = ActionSmoothingWrapper(HighwayObstacleEnv(max_steps=120), alpha=0.7)
    import os
    ...
    for k in range(120):
        ...
        states.append(base_env.state.copy())
    ...
    plot_trajectory(states, base_env.model, show=False, save_path="logs/trajectory.png")
    plot_states_and_inputs(states, inputs, base_env.model.dt, show=False, save_path="logs/states_inputs.png")
